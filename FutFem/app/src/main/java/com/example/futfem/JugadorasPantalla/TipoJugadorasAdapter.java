...
public class TipoJugadorasAdapter extends RecyclerView.Adapter<TipoJugadoraHolder> {
    private TipoJugadoraList jugadorasToShow;

    public TipoJugadorasAdapter(TipoJugadoraList jugadoras){
    ...
    public TipoJugadoraHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View cellView = inflater.inflate(R.layout.jugadoras_recycler_cell, parent, false);
