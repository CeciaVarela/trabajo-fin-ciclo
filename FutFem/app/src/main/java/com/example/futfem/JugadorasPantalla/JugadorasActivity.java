...
import com.example.futfem.EquiposPantalla.TipoEquipoAdapter;
...
public class JugadorasActivity extends AppCompatActivity {
    ...
    public void setJugadoras(TipoJugadoraList jugadoras){
        ...
        TipoJugadorasAdapter myAdapter = new TipoJugadorasAdapter(this.jugadoras);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jugadoras);
        this.queue = Volley.newRequestQueue(context);
        this.mainLayout = findViewById(R.id.main_layoutJugadoras);
...
//        recyclerView.setHasFixedSize(true);
    ...
    private void requestJugadoras() {
        int id = getIntent().getIntExtra(JugadorasActivity.CAMPO_ID_EQUIPO, 7);
